# Operator Quickstart — Schedule Facility Maintenance

Shortest path from clone to a verified local dry-run for **ISIC 920** (`cloud-itonami-isic-920`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-920.git
cd cloud-itonami-isic-920
```
...
- Likely source path: `gamblingfacilityops.governor.cljc`
